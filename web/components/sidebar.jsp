...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-30 flex h-screen w-72 -translate-x-full flex-col bg-slate-900 text-white transition-transform duration-300 lg:static lg:translate-x-0">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <a href="MainController?action=listPurchaseOrder" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg <%= "purchaseorder".equals(activePage) ? "bg-teal-500/20 text-teal-300 font-medium" : "text-slate-300 hover:bg-slate-800" %>">
